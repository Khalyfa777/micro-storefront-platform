...
try {
  ...
  useEffect(() => {
    ...
    if (token && isPlatformAdmin && activeTab === "settings") {
      ...
      <main className="login-page premium-login-page">
        <section className="login-hero-card">
          ...
          <form className="login-card premium-login-card" onSubmit={login}>
            ...
            <button className="premium-login-btn" type="submit">
              Login to dashboard
            </button>
    ...
    <main className="dashboard">
      ...
      <section className="content">
        <div className="topbar">
          <div>
            <h1>{selectedStore?.name || "Dashboard"}</h1>
            <p className="muted">
          ...
          <button
            onClick={() => {
              ...
              if (isPlatformAdmin && activeTab === "settings") {
          ...
          >
            {isPlatformAdmin && activeTab === "settings" ? "Refresh admin data" : "Refresh"}
          </button>
        </div>
...
{uploadingProductImage && (
  <p className="upload-note">Uploading image...</p>
)}
  ...
  <div className="uploaded-image-preview">
    ...
    <p>Image uploaded successfully</p>
              ...
              <div className="form-actions">
                <button type="submit" disabled={isProductSubmitDisabled()}>{getProductSubmitLabel()}</button>
              ...
              {products.map((product) => (
                <article className="product-card" key={product.id}>
                  ...
                  <div className="product-meta">
                    ...
                    <span>Stock: {product.stock_quantity ?? "Unlimited"}</span>
                    <span className={product.is_active ? "pill active-pill" : "pill inactive-pill"}>
                      {product.is_active ? "Active" : "Inactive"}
                    </span>
                    {product.is_featured && <span className="pill">Featured</span>}
                  </div>
